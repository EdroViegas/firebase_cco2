...
class SymptomaticCases extends StatefulWidget {
  @override
  _SymptomaticCasesState createState() => _SymptomaticCasesState();
}

class _SymptomaticCasesState extends State<SymptomaticCases> {
      ...
      body: Center(
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('cases')
              .where("symptomatic", isEqualTo: true)
